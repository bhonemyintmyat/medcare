...
'Owned visual consistency, ran usability testing, and checked the layout on mobile.':
  'အမြင်ပိုင်းဆိုင်ရာ တစ်သမတ်တည်းဖြစ်မှုကို တာဝန်ယူပြီး အသုံးပြုရလွယ်ကူမှု စမ်းသပ်မှုများ ပြုလုပ်ကာ မိုဘိုင်းပေါ်တွင် အပြင်အဆင်ကို စစ်ဆေးခဲ့သည်။',
    ...
    'Pick a password: At least 8 characters, with an upper-case letter, a lower-case letter, a number, and a symbol. Your account starts with the "user" role.': 'စကားဝှက် ရွေးပါ — အနည်းဆုံး စာလုံး ၈ လုံး ရှိပြီး အင်္ဂလိပ် စာလုံးကြီး တစ်လုံး၊ စာလုံးသေး တစ်လုံး၊ ဂဏန်း တစ်လုံးနှင့် သင်္ကေတ တစ်ခု ပါရမည်။ သင့်အကောင့်သည် "user" ရာထူးဖြင့် စတင်သည်။',
    ...
    'Passwords need at least one symbol, such as ! ? # or @.': 'စကားဝှက်တွင် ! ? # သို့မဟုတ် @ ကဲ့သို့ သင်္ကေတ အနည်းဆုံး တစ်ခု ပါရမည်။',
